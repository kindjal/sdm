...
class System::Disk::Filer {
    ...
    has_many_optional => [
        #arrays          => { is => 'System::Disk::Array', via => 'host', to => 'arrays' },
        hostmapping     => { is => 'System::Disk::FilerHostBridge', reverse_as => 'filer' },
        hostname        => { via => 'hostmapping' },
        host            => { is => 'System::Disk::Host', reverse_as => 'filer', via => 'hostmapping' },
        arrayname       => { via => 'host' },
