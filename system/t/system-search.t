...
my $individual = System::Disk::Volume->create(
    filername => 'nfs11',
...
my $volume = System::Disk::Volume->get();
my $volume_doc = System::Search->generate_document($volume); #Model ID mentioned in ReferenceAlignment.t
