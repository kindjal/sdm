...
<xsl:template name="sdm_disk_host_set" match="/object[@type='SDM::Disk::Host::Set']">
  <xsl:comment>template: /html/table/sdm_disk_host_set.xsl match="object[@type='SDM::Disk::Host::Set']"</xsl:comment>
  ...
  <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    ...
    <body id="dt_example">
    <div id="container">
      <table width="100%" cellspacing="0" cellpadding="0" border="0" id="hosttable" class="display" use-attribute-sets="table-cell-attrs">
        <thead>
          <tr>
