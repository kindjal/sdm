...
package Sdm::Disk::Volume::Command::Assign;
...
class Sdm::Disk::Volume::Command::Assign {
    is  => 'Sdm::Command::Base',
    doc => 'assign volumes to groups',
    has => [
        volume => { is => 'Sdm::Disk::Volume', shell_args_position => 1 },
        group  => { is => 'Sdm::Disk::Group',  shell_args_position => 2 },
    ],
};
