...
class System::Disk::Host {
    ...
    has_many_optional => [
        #filers          => { is => 'System::Disk::Filer', id_by => 'filername' },
        exports         => { is => 'System::Disk::Export', reverse_as => 'host' },
        mappings        => { is => 'System::Disk::HostArrayBridge', reverse_as => 'host' },
        arrays          => { is => 'System::Disk::Array', via => 'mappings', to => 'arrays' },
        arraynames      => { via => 'arrays', to => 'arraynames' },
    ],
    schema_name => 'Disk',
