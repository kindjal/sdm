...
require System::Utility::Text;
require Lingua::EN::Inflect;

class System::Command::Crud {
...
sub init_sub_commands {
    ...
    : join(' ', map { System::Utility::Text::camel_case_to_string($_) } split('::', $config{target_class}));
