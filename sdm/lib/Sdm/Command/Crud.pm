...
require Sdm::Utility::Text;
require Lingua::EN::Inflect;

class Sdm::Command::Crud {
...
sub init_sub_commands {
    ...
    : join(' ', map { Sdm::Utility::Text::camel_case_to_string($_) } split('::', $config{target_class}));
